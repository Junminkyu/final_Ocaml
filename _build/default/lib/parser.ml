...
let rec _menhir_goto_expressions : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expression list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState0 ->
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _menhir_s, (e : (Ast.expression list))) = _menhir_stack in
...
# 66 "lib/parser.ml"
    ...
    | MenhirState16 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, (e : (Ast.expression))), _, (es : (Ast.expression list))) = _menhir_stack in
        let _v : (Ast.expression list) = 
# 22 "lib/parser.mly"
                                       ( e::es )
# 85 "lib/parser.ml"
...
and _menhir_reduce1 : _menhir_env -> ('ttv_tail * _menhir_state) * _menhir_state * (Ast.expression) -> 'ttv_return =
...
and _menhir_run2 : _menhir_env -> 'ttv_tail * _menhir_state -> _menhir_state -> (
# 6 "lib/parser.mly"
       (string)
# 249 "lib/parser.ml"
) -> 'ttv_return =
