...
module Substitution = struct
  module MM = Map.Make(String)
    ...
    let rec match_expression (variables:string list) (pattern:expression) (goal:expression) : t =
      ...
      |Application(a1,a2), Application(b1,b2) -> List.fold_left2 
                          (fun substitution a1 b1 ->merge substitution (match_expression variables a1 b1))
                          (match_expression variables a1 b1) a2 b2
