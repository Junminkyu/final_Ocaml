...
# 72 "expression/lib/parser.ml"
     in
    let _menhir_stack = Obj.magic _menhir_stack in
    let _menhir_stack = Obj.magic _menhir_stack in
    let (_1 : (Ast.declaration)) = _v in
    let _v : (Ast.decision_level) = 
# 29 "expression/lib/parser.mly"
              (DecisionLevDeclaration _1)
# 80 "expression/lib/parser.ml"
     in
...
and _menhir_goto_decision_level : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.decision_level) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | EOF ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (_menhir_stack, _menhir_s, (_1 : (Ast.decision_level))) = _menhir_stack in
        let _v : (Ast.decision_level) = 
# 26 "expression/lib/parser.mly"
                       ( _1 )
# 118 "expression/lib/parser.ml"
         in
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (_1 : (Ast.decision_level)) = _v in
        Obj.magic _1
    | _ ->
        assert (not _menhir_env._menhir_error);
        _menhir_env._menhir_error <- true;
        ...
        | HINT ->
            ...
            | AXIOM ->
                ...
                | ENDCOMMENT ->
                    ...
                    let _menhir_stack = Obj.magic _menhir_stack in
                    let _v : (Ast.hint) = 
# 47 "expression/lib/parser.mly"
                       (Axiom)
# 179 "expression/lib/parser.ml"
                     in
                    let _menhir_stack = Obj.magic _menhir_stack in
                    let _menhir_stack = Obj.magic _menhir_stack in
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState5 ->
        ...
        | RPAREN ->
            ...
            let _v : (Ast.expression) = 
# 53 "expression/lib/parser.mly"
                                          (Application(e1,e2))
# 401 "expression/lib/parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 444 "expression/lib/parser.ml"
    ...
    | MenhirState0 ->
        ...
        | EOF ->
            ...
            let _v : (Ast.decision_level) = 
# 30 "expression/lib/parser.mly"
             (DecisionLevExpression _1 )
# 485 "expression/lib/parser.ml"
             in
            _menhir_goto_decision_level _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 6 "expression/lib/parser.mly"
       (string)
# 597 "expression/lib/parser.ml"
            )) = _v in
            let (_menhir_stack, _menhir_s, (nm : (
# 6 "expression/lib/parser.mly"
       (string)
# 602 "expression/lib/parser.ml"
            ))) = _menhir_stack in
            let _v : (Ast.typedVar) = 
# 38 "expression/lib/parser.mly"
                          (TypeVariable(nm,t))
# 607 "expression/lib/parser.ml"
             in
            _menhir_goto_input _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 6 "expression/lib/parser.mly"
       (string)
# 634 "expression/lib/parser.ml"
    )) = _v in
    let _v : (Ast.expression) = 
# 51 "expression/lib/parser.mly"
         (Identifier nm)
# 639 "expression/lib/parser.ml"
     in
    _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
...
and main : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Ast.decision_level) =
  fun lexer lexbuf ->
    let _menhir_env = {
      _menhir_lexer = lexer;
      _menhir_lexbuf = lexbuf;
