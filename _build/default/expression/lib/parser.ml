  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState58 ->
        ...
        | RPAREN ->
            ...
            let _v : (Ast.equality) = 
# 70 "expression/lib/parser.mly"
                          (e)
# 123 "expression/lib/parser.ml"
             in
        ...
        | HINT ->
            ...
            | AXIOM ->
                ...
                | ENDCOMMENT ->
                    ...
                    let _menhir_stack = Obj.magic _menhir_stack in
                    let _v : (Ast.hint) = 
# 74 "expression/lib/parser.mly"
                       (Axiom)
# 154 "expression/lib/parser.ml"
                     in
...
# 6 "expression/lib/parser.mly"
       (string)
# 180 "expression/lib/parser.ml"
                        ))) = _menhir_stack in
                        let _v : (Ast.hint) = 
# 75 "expression/lib/parser.mly"
                                    (Induction nm)
# 185 "expression/lib/parser.ml"
                         in
                        _menhir_goto_hint _menhir_env _menhir_stack _v
                    | _ ->
                        assert (not _menhir_env._menhir_error);
...
# 78 "expression/lib/parser.mly"
                           (e)
# 242 "expression/lib/parser.ml"
     in
...
# 6 "expression/lib/parser.mly"
       (string)
# 271 "expression/lib/parser.ml"
    )) = _v in
    let (_menhir_stack, _menhir_s, (e1 : (Ast.expression))) = _menhir_stack in
    let _v : (Ast.expression) = 
# 82 "expression/lib/parser.mly"
                       (Express(e1,nm))
# 277 "expression/lib/parser.ml"
     in
    _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_goto_element : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.element) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    let _v : (Ast.vert) = 
# 63 "expression/lib/parser.mly"
                   (Vertical(e1))
# 350 "expression/lib/parser.ml"
     in
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState9 ->
        ...
        | RPAREN ->
            ...
            let _v : (Ast.expression) = 
# 83 "expression/lib/parser.mly"
                                          (Application(e1,e2))
# 412 "expression/lib/parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState13 ->
        ...
        | ARROW | EOF | EQUAL | HINT | LET | RPAREN | TYPE | VERT ->
            ...
            let ((_menhir_stack, _menhir_s, (e1 : (Ast.expression))), _, (e2 : (Ast.expression))) = _menhir_stack in
            let _v : (Ast.expression) = 
# 81 "expression/lib/parser.mly"
                                   (Comma(e1,e2))
# 440 "expression/lib/parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState15 ->
        ...
        | ARROW | EOF | EQUAL | HINT | LET | RPAREN | TYPE | VERT ->
            ...
            let ((_menhir_stack, _menhir_s, (e1 : (Ast.expression))), _, (e2 : (Ast.expression))) = _menhir_stack in
            let _v : (Ast.expression) = 
# 80 "expression/lib/parser.mly"
                                   (Colon(e1,e2))
# 468 "expression/lib/parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState27 ->
        ...
        | EOF | LET | TYPE | VERT ->
            ...
            let ((_menhir_stack, _menhir_s, (e1 : (Ast.expression))), _, (e2 : (Ast.expression))) = _menhir_stack in
            let _v : (Ast.element) = 
# 60 "expression/lib/parser.mly"
                                     (ArrowStatement(e1,e2))
# 528 "expression/lib/parser.ml"
             in
    ...
    | MenhirState60 ->
        ...
        | EOF | HINT | LET | RPAREN | TYPE ->
            ...
            let _v : (Ast.equality) = 
# 71 "expression/lib/parser.mly"
                                     (Equality(lhs,rhs))
# 579 "expression/lib/parser.ml"
             in
            _menhir_goto_equality _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState19 ->
        ...
        | RPAREN ->
            ...
            let _v : (Ast.astrik) = 
# 51 "expression/lib/parser.mly"
                           (astr)
# 631 "expression/lib/parser.ml"
             in
    ...
    | MenhirState23 ->
        ...
        | EOF | LET | RPAREN | TYPE | VERT ->
            ...
            let _v : (Ast.astrik) = 
# 50 "expression/lib/parser.mly"
                              (AstrikType(e1,e2))
# 653 "expression/lib/parser.ml"
             in
            _menhir_goto_astrik _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 6 "expression/lib/parser.mly"
       (string)
# 674 "expression/lib/parser.ml"
            ))), _, (t : (Ast.astrik))) = _menhir_stack in
            let _v : (Ast.constructor) = 
# 54 "expression/lib/parser.mly"
                         (NormalType(e1,t))
# 679 "expression/lib/parser.ml"
             in
...
# 6 "expression/lib/parser.mly"
       (string)
# 742 "expression/lib/parser.ml"
        ))) = _menhir_stack in
        let _v : (Ast.declaration) = 
# 38 "expression/lib/parser.mly"
      (TypeDeclaration(type_name,vertical))
# 747 "expression/lib/parser.ml"
         in
        _menhir_goto_declaration _menhir_env _menhir_stack _menhir_s _v
    | MenhirState49 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 6 "expression/lib/parser.mly"
       (string)
# 757 "expression/lib/parser.ml"
        ))) = _menhir_stack in
        let _v : (Ast.match_statement) = 
# 66 "expression/lib/parser.mly"
                                   (Matching(nm,e1))
# 762 "expression/lib/parser.ml"
         in
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 6 "expression/lib/parser.mly"
       (string)
# 770 "expression/lib/parser.ml"
        ))), _, (args : (Ast.typedVar list))), (output_type : (
# 6 "expression/lib/parser.mly"
       (string)
# 774 "expression/lib/parser.ml"
        ))) = _menhir_stack in
        let _v : (Ast.declaration) = 
# 40 "expression/lib/parser.mly"
      (RecDeclaration(function_name,args,output_type,m))
# 779 "expression/lib/parser.ml"
         in
        _menhir_goto_declaration _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        _menhir_fail ()
...
and _menhir_goto_constructor : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.constructor) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    let _v : (Ast.element) = 
# 59 "expression/lib/parser.mly"
                 (Construct(nm))
# 808 "expression/lib/parser.ml"
     in
    _menhir_goto_element _menhir_env _menhir_stack _menhir_s _v
...
# 6 "expression/lib/parser.mly"
       (string)
# 815 "expression/lib/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let (_menhir_stack, _menhir_s, (nm : (
# 6 "expression/lib/parser.mly"
       (string)
# 821 "expression/lib/parser.ml"
    ))) = _menhir_stack in
    let _v : (Ast.expression) = 
# 79 "expression/lib/parser.mly"
         (Identifier nm)
# 826 "expression/lib/parser.ml"
     in
    _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
...
# 6 "expression/lib/parser.mly"
       (string)
# 856 "expression/lib/parser.ml"
    )) = _v in
    let _v : (Ast.astrik) = 
# 49 "expression/lib/parser.mly"
          (LastAstrik(nm))
# 861 "expression/lib/parser.ml"
     in
    _menhir_goto_astrik _menhir_env _menhir_stack _menhir_s _v
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState37 ->
        ...
        | RPAREN ->
            ...
            let _v : (Ast.typedVar) = 
# 45 "expression/lib/parser.mly"
                         (arg)
# 1002 "expression/lib/parser.ml"
             in
...
# 32 "expression/lib/parser.mly"
                          ( _1 )
# 1045 "expression/lib/parser.ml"
             in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
...
# 6 "expression/lib/parser.mly"
       (string)
# 1112 "expression/lib/parser.ml"
            ))) = _menhir_stack in
            let _v : (Ast.constructor) = 
# 55 "expression/lib/parser.mly"
          (SimpleType(nm))
# 1117 "expression/lib/parser.ml"
             in
            _menhir_goto_constructor _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 6 "expression/lib/parser.mly"
       (string)
# 1179 "expression/lib/parser.ml"
            )) = _v in
            let (_menhir_stack, _menhir_s, (nm : (
# 6 "expression/lib/parser.mly"
       (string)
# 1184 "expression/lib/parser.ml"
            ))) = _menhir_stack in
            let _v : (Ast.typedVar) = 
# 44 "expression/lib/parser.mly"
                          (TypeVariable(nm,t))
# 1189 "expression/lib/parser.ml"
             in
            _menhir_goto_input _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
